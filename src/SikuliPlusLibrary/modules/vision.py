...
class VisionModule:
    ...
    def wait_for_image(self, image_path: str, timeout: int, similarity: float = 0.7, roi: Optional[List[int]] = None) -> Optional[str]:
        self.sikuli.run_keyword("Wait Until Screen Contain", [image_path, timeout])
